...
#ifndef SMMU_KODIAK_CFG_H
#define SMMU_KODIAK_CFG_H

#include <kodiak_def.h>

#define APPS_SMMU_CUSTOM_CFG_ADDR                                             QTI_SMMU_CFG_BASE + 0x002300
#define APPS_SMMU_CUSTOM_CFG                                                  0x60480010

#define APPS_SMMU_CUSTOM_CFG_SEC_ADDR                                         QTI_SMMU_CFG_BASE + 0x0022fc
#define APPS_SMMU_CUSTOM_CFG_SEC                                              0x000006f0

#define APPS_SMMU_ACR_ADDR                                                    QTI_SMMU_CFG_BASE + 0x000010
#define APPS_SMMU_ACR                                                         0x0000001c

#define APPS_SMMU_NSACR_ADDR                                                  QTI_SMMU_CFG_BASE + 0x000410
#define APPS_SMMU_NSACR                                                       0x0000001c

#define APPS_SMMU_SAFE_SEC_CFG_ADDR                                           QTI_SMMU_CFG_BASE + 0x002648
#define APPS_SMMU_SAFE_SEC_CFG                                                0x00000000

#define APPS_SMMU_MTLB_DEPTH_ADDR                                             QTI_SMMU_CFG_BASE + 0x002524
#define APPS_SMMU_MTLB_DEPTH                                                  0x000001ff

#define APPS_SMMU_PFB_DEPTH_ADDR                                              QTI_SMMU_CFG_BASE + 0x002564
#define APPS_SMMU_PFB_DEPTH                                                   0x000001ff

#define APPS_SMMU_SPARE_REG_1_SEC_ADDR                                        QTI_SMMU_CFG_BASE + 0x1d8030
#define APPS_SMMU_SPARE_REG_1_SEC                                             0x0000080f

#define APPS_SMMU_CLOCK_GATING_SEC_ADDR                                       QTI_SMMU_CFG_BASE + 0x1d8010
#define APPS_SMMU_CLOCK_GATING_SEC                                            0x000400ff

#define APPS_SMMU_CLIENT_DEBUG_SSD_INDEX_HYP_HLOS_EN_ANOC_1_SEC_ADDR          QTI_SMMU_CFG_BASE + 0x1dc010
#define APPS_SMMU_CLIENT_DEBUG_SSD_INDEX_HYP_HLOS_EN_ANOC_1_SEC               0x000103ff

#define APPS_SMMU_CLIENT_DEBUG_SSD_INDEX_HYP_HLOS_EN_ANOC_2_SEC_ADDR          QTI_SMMU_CFG_BASE + 0x1e0010
#define APPS_SMMU_CLIENT_DEBUG_SSD_INDEX_HYP_HLOS_EN_ANOC_2_SEC               0x000103ff

#define APPS_SMMU_CLIENT_DEBUG_SSD_INDEX_HYP_HLOS_EN_MNOC_HF_0_SEC_ADDR       QTI_SMMU_CFG_BASE + 0x1e4010
#define APPS_SMMU_CLIENT_DEBUG_SSD_INDEX_HYP_HLOS_EN_MNOC_HF_0_SEC            0x000103ff

#define APPS_SMMU_CLIENT_DEBUG_SSD_INDEX_HYP_HLOS_EN_MNOC_HF_1_SEC_ADDR       QTI_SMMU_CFG_BASE + 0x1e8010
#define APPS_SMMU_CLIENT_DEBUG_SSD_INDEX_HYP_HLOS_EN_MNOC_HF_1_SEC            0x000103ff

#define APPS_SMMU_CLIENT_DEBUG_SSD_INDEX_HYP_HLOS_EN_COMPUTE_DSP_1_SEC_ADDR   QTI_SMMU_CFG_BASE + 0x1ec010
#define APPS_SMMU_CLIENT_DEBUG_SSD_INDEX_HYP_HLOS_EN_COMPUTE_DSP_1_SEC        0x000103ff

#define APPS_SMMU_CLIENT_DEBUG_SSD_INDEX_HYP_HLOS_EN_COMPUTE_DSP_0_SEC_ADDR   QTI_SMMU_CFG_BASE + 0x1f0010
#define APPS_SMMU_CLIENT_DEBUG_SSD_INDEX_HYP_HLOS_EN_COMPUTE_DSP_0_SEC        0x000103ff

#define APPS_SMMU_CLIENT_DEBUG_SSD_INDEX_HYP_HLOS_EN_LPASS_SEC_ADDR           QTI_SMMU_CFG_BASE + 0x1f4010
#define APPS_SMMU_CLIENT_DEBUG_SSD_INDEX_HYP_HLOS_EN_LPASS_SEC                0x000103ff

#define APPS_SMMU_CLIENT_DEBUG_SSD_INDEX_HYP_HLOS_EN_ANOC_PCIE_SEC_ADDR       QTI_SMMU_CFG_BASE + 0x1f8010
#define APPS_SMMU_CLIENT_DEBUG_SSD_INDEX_HYP_HLOS_EN_ANOC_PCIE_SEC            0x000103ff

#define APPS_SMMU_CLIENT_DEBUG_SSD_INDEX_HYP_HLOS_EN_MNOC_SF_0_SEC_ADDR       QTI_SMMU_CFG_BASE + 0x1fc010
#define APPS_SMMU_CLIENT_DEBUG_SSD_INDEX_HYP_HLOS_EN_MNOC_SF_0_SEC            0x000103ff

#define APPS_SMMU_CLIENT_DEBUG_SID_HALT_MNOC_HF_1_SEC_ADDR                    QTI_SMMU_CFG_BASE + 0x1e8000
#define APPS_SMMU_CLIENT_DEBUG_SID_HALT_MNOC_HF_1_SEC                         0x80104000

#define APPS_SMMU_CLIENT_DEBUG_SID_HALT_MNOC_HF_0_SEC_ADDR                    QTI_SMMU_CFG_BASE + 0x1e4000
#define APPS_SMMU_CLIENT_DEBUG_SID_HALT_MNOC_HF_0_SEC                         0x80104000

#define APPS_SMMU_CLIENT_DEBUG_SID_HALT_ANOC_1_SEC_ADDR                       QTI_SMMU_CFG_BASE + 0x1dc000
#define APPS_SMMU_CLIENT_DEBUG_SID_HALT_ANOC_1_SEC                            0x80100000

#define APPS_SMMU_CLIENT_DEBUG_SID_HALT_ANOC_2_SEC_ADDR                       QTI_SMMU_CFG_BASE + 0x1e0000
#define APPS_SMMU_CLIENT_DEBUG_SID_HALT_ANOC_2_SEC                            0x80100000

#define APPS_SMMU_CLIENT_DEBUG_SID_HALT_COMPUTE_DSP_1_SEC_ADDR                QTI_SMMU_CFG_BASE + 0x1ec000
#define APPS_SMMU_CLIENT_DEBUG_SID_HALT_COMPUTE_DSP_1_SEC                     0x80100000

#define APPS_SMMU_CLIENT_DEBUG_SID_HALT_COMPUTE_DSP_0_SEC_ADDR                QTI_SMMU_CFG_BASE + 0x1f0000
#define APPS_SMMU_CLIENT_DEBUG_SID_HALT_COMPUTE_DSP_0_SEC                     0x80100000

#define APPS_SMMU_CLIENT_DEBUG_SID_HALT_LPASS_SEC_ADDR                        QTI_SMMU_CFG_BASE + 0x1f4000
#define APPS_SMMU_CLIENT_DEBUG_SID_HALT_LPASS_SEC                             0x80100000

#define APPS_SMMU_CLIENT_DEBUG_SID_HALT_ANOC_PCIE_SEC_ADDR                    QTI_SMMU_CFG_BASE + 0x1f8000
#define APPS_SMMU_CLIENT_DEBUG_SID_HALT_ANOC_PCIE_SEC                         0x80100000

#define APPS_SMMU_CLIENT_DEBUG_SID_HALT_MNOC_SF_0_SEC_ADDR                    QTI_SMMU_CFG_BASE + 0x1fc000
#define APPS_SMMU_CLIENT_DEBUG_SID_HALT_MNOC_SF_0_SEC                         0x80100000

#define APPS_SMMU_CLIENT_DEBUG_WUSER_ANOC_1_SEC_ADDR                          QTI_SMMU_CFG_BASE + 0x1dc038
#define APPS_SMMU_CLIENT_DEBUG_WUSER_ANOC_1_SEC                               0x00000000

#define APPS_SMMU_CLIENT_DEBUG_WUSER_ANOC_2_SEC_ADDR                          QTI_SMMU_CFG_BASE + 0x1e0038
#define APPS_SMMU_CLIENT_DEBUG_WUSER_ANOC_2_SEC                               0x00000000

#define APPS_SMMU_CLIENT_DEBUG_WUSER_MNOC_HF_0_SEC_ADDR                       QTI_SMMU_CFG_BASE + 0x1e4038
#define APPS_SMMU_CLIENT_DEBUG_WUSER_MNOC_HF_0_SEC                            0x00000000

#define APPS_SMMU_CLIENT_DEBUG_WUSER_MNOC_HF_1_SEC_ADDR                       QTI_SMMU_CFG_BASE + 0x1e8038
#define APPS_SMMU_CLIENT_DEBUG_WUSER_MNOC_HF_1_SEC                            0x00000000

#define APPS_SMMU_CLIENT_DEBUG_WUSER_COMPUTE_DSP_1_SEC_ADDR                   QTI_SMMU_CFG_BASE + 0x1ec038
#define APPS_SMMU_CLIENT_DEBUG_WUSER_COMPUTE_DSP_1_SEC                        0x00000000

#define APPS_SMMU_CLIENT_DEBUG_WUSER_COMPUTE_DSP_0_SEC_ADDR                   QTI_SMMU_CFG_BASE + 0x1f0038
#define APPS_SMMU_CLIENT_DEBUG_WUSER_COMPUTE_DSP_0_SEC                        0x00000000

#define APPS_SMMU_CLIENT_DEBUG_WUSER_LPASS_SEC_ADDR                           QTI_SMMU_CFG_BASE + 0x1f4038
#define APPS_SMMU_CLIENT_DEBUG_WUSER_LPASS_SEC                                0x00000000

#define APPS_SMMU_CLIENT_DEBUG_WUSER_ANOC_PCIE_SEC_ADDR                       QTI_SMMU_CFG_BASE + 0x1f8038
#define APPS_SMMU_CLIENT_DEBUG_WUSER_ANOC_PCIE_SEC                            0x00000000

#define APPS_SMMU_CLIENT_DEBUG_WUSER_MNOC_SF_0_SEC_ADDR                       QTI_SMMU_CFG_BASE + 0x1fc038
