...
#ifndef _XPU_TARGET_INFO_H_
#define _XPU_TARGET_INFO_H_

#include <kodiak_def.h>
#include <xpu3.h>

#define MSM_XPU_ERR_INT_REG_NUM       2
#define MSM_XPU_ERR_NUM_PER_REG       32
...
extern xpu_err_pos_to_hal_map_t xpu_err_pos_to_hal_map
	[MSM_XPU_ERR_INT_REG_NUM][MSM_XPU_ERR_NUM_PER_REG];

extern const xpu_intr_reg_dtls_t
