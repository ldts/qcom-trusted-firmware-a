...
#define NUM_MODEM_MPU_PARTITIONS 9
#define NUM_MSS_NAV_MPU_PARTITIONS 7
#define NUM_RPM_MPU_PARTITIONS 5

#define XPU_ADDR_TYPE(hwiosym) HWIO_##hwiosym##_ADDR

#define HWIO_OCIMEM_MPU_XPU3_GCR0_ADDR			(0x61C000)
#define HWIO_BOOT_ROM_XPU3_GCR0_ADDR			(0x3fe000)
#define HWIO_IPA_0_GSI_TOP_XPU3_GCR0_ADDR		(0x1e00000)
#define HWIO_LLCC0_LLCC_XPU3_GCR0_ADDR			(0x922e000)
#define HWIO_LLCC1_LLCC_XPU3_GCR0_ADDR			(0x92ae000)
#define HWIO_LLCC_BROADCAST_LLCC_XPU3_GCR0_ADDR		(0x962e000)
#define HWIO_AOSS_MPU_XPU3_GCR0_ADDR			(0x1522000)
#define HWIO_SEC_CTRL_APU_XPU3_GCR0_ADDR		(0x78e000)
#define HWIO_AOSS_CNOC_MPU_XPU3_GCR0_ADDR		(0xeff0000)
...
#define HWIO_QHS_NON_BROADCAST_MPU_XPU3_GCR0_ADDR	(0x90C4000)
#define HWIO_CNOC_GEMNOC_MPU_XPU3_GCR0_ADDR             (0x152C000)
#define HWIO_CNOC2_SS_MPU_XPU3_GCR0_ADDR                (0x01530000)
#define HWIO_WPSS_MPU_XPU3_GCR0_ADDR                    (0x08B14000)
#define HWIO_MDSS_0_MDSS_XPU3_GCR0_ADDR                 (0x0AEC8000)
#define HWIO_MDSS_1_MDSS_XPU3_GCR0_ADDR                 (0x220C8000)
...
extern struct xpu_err_pos_to_hal_map xpu_err_pos_to_hal_map[ACC_XPU_ERR_INT_REG_NUM][ACC_XPU_ERR_NUM_PER_REG];
extern const struct xpu_intr_reg_dtls xpu_non_sec_intr_status_reg[ACC_XPU_ERR_INT_REG_NUM];
extern const struct xpu_intr_reg_dtls xpu_sec_intr_status_reg[ACC_XPU_ERR_INT_REG_NUM];
extern const struct xpu_intr_reg_dtls xpu_non_sec_intr_en_reg[ACC_XPU_ERR_INT_REG_NUM];
extern const struct xpu_intr_reg_dtls xpu_sec_intr_en_reg[ACC_XPU_ERR_INT_REG_NUM];
