	...
	[ACC_XPU_ERR_INT_REG_NUM][ACC_XPU_ERR_NUM_PER_REG] =
{
	...
	},
	{
		...
		{ BIT(7),  XPU_TYPE_MDSS_0_MDSS_APU },
		{ BIT(11), XPU_TYPE_IPA_0_GSI_TOP },
		{ BIT(13), XPU_TYPE_DC_NOC_SHRM_MPU },
		{ BIT(15), XPU_TYPE_MDSS_1_MDSS_APU },
...
const struct xpu_intr_reg_dtls xpu_non_sec_intr_status_reg
	[ACC_XPU_ERR_INT_REG_NUM] =
{
	{
...
const struct xpu_intr_reg_dtls xpu_sec_intr_en_reg
	[ACC_XPU_ERR_INT_REG_NUM] =
{
	{
...
const struct xpu_intr_reg_dtls xpu_non_sec_intr_en_reg
	[ACC_XPU_ERR_INT_REG_NUM] =
{
	{
...
const struct xpu_intr_reg_dtls xpu_sec_intr_status_reg
	[ACC_XPU_ERR_INT_REG_NUM] =
{
	{
...
struct xpu_base_addr_info g_xpu_base_addr_array[] = {
	...
	},
	{
		...
		XPU_ADDR_TYPE(MDSS_0_MDSS_XPU3_GCR0),
		"MDSS_0_MDSS_APU"
	},
	{
		XPU_TYPE_MDSS_1_MDSS_APU,
		XPU_ADDR_TYPE(MDSS_1_MDSS_XPU3_GCR0),
		"MDSS_1_MDSS_APU"
	},
};
