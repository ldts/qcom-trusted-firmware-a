...
#ifndef _VMIDMT_HAL_HWIO_H_
#define _VMIDMT_HAL_HWIO_H_

#include <lib/mmio.h>

#define __inpdw(port) mmio_read_32(port)
...
#define out_dword_masked_ns(io, mask, val, current_reg_content) \
	mmio_write_32(                                          \
		(io),                                           \
		((current_reg_content & (uint32_t)(~(mask))) |  \
		 (uint32_t)((val) & (mask)))                    \
	)
...
#define VMIDMT_SCR0_IN(b) \
	in_dword_masked(VMIDMT_SCR0_ADDR(b), VMIDMT_SCR0_RMSK)
#define VMIDMT_SCR0_INM(b, m) \
	in_dword_masked(VMIDMT_SCR0_ADDR(b), (m))
#define VMIDMT_SCR0_OUT(b, v) \
	mmio_write_32(VMIDMT_SCR0_ADDR(b), (v))
...
#define VMIDMT_CR0_IN(b) \
	in_dword_masked(VMIDMT_CR0_ADDR(b), VMIDMT_CR0_RMSK)
#define VMIDMT_CR0_INM(b, m) \
	in_dword_masked(VMIDMT_CR0_ADDR(b), (m))
#define VMIDMT_CR0_OUT(b, v) \
	mmio_write_32(VMIDMT_CR0_ADDR(b), (v))
...
#define VMIDMT_NSCR0_INM(b, m) \
	in_dword_masked(VMIDMT_NSCR0_ADDR(b), (m))
#define VMIDMT_NSCR0_OUT(b, v) \
	mmio_write_32(VMIDMT_NSCR0_ADDR(b), (v))
...
#define VMIDMT_SCR1_IN(b) \
	in_dword_masked(VMIDMT_SCR1_ADDR(b), VMIDMT_SCR1_RMSK)
#define VMIDMT_SCR1_INM(b, m) \
	in_dword_masked(VMIDMT_SCR1_ADDR(b), (m))
#define VMIDMT_SCR1_OUT(b, v) \
	mmio_write_32(VMIDMT_SCR1_ADDR(b), (v))
...
#define VMIDMT_SCR2_IN(b) \
	in_dword_masked(VMIDMT_SCR2_ADDR(b), VMIDMT_SCR2_RMSK)
#define VMIDMT_SCR2_INM(b, m) \
	in_dword_masked(VMIDMT_SCR2_ADDR(b), (m))
#define VMIDMT_SCR2_OUT(b, v) \
	mmio_write_32(VMIDMT_SCR2_ADDR(b), (v))
...
#define VMIDMT_CR2_IN(b) \
	in_dword_masked(VMIDMT_CR2_ADDR(b), VMIDMT_CR2_RMSK)
#define VMIDMT_CR2_INM(b, m) \
	in_dword_masked(VMIDMT_CR2_ADDR(b), (m))
#define VMIDMT_CR2_OUT(b, v) \
	mmio_write_32(VMIDMT_CR2_ADDR(b), (v))
...
#define VMIDMT_NSCR2_INM(b, m) \
	in_dword_masked(VMIDMT_NSCR2_ADDR(b), (m))
#define VMIDMT_NSCR2_OUT(b, v) \
	mmio_write_32(VMIDMT_NSCR2_ADDR(b), (v))
...
#define VMIDMT_SACR_IN(b) \
	in_dword_masked(VMIDMT_SACR_ADDR(b), VMIDMT_SACR_RMSK)
#define VMIDMT_SACR_INM(b, m) \
	in_dword_masked(VMIDMT_SACR_ADDR(b), (m))
#define VMIDMT_SACR_OUT(b, v) \
	mmio_write_32(VMIDMT_SACR_ADDR(b), (v))
...
#define VMIDMT_ACR_IN(b) \
	in_dword_masked(VMIDMT_ACR_ADDR(b), VMIDMT_ACR_RMSK)
#define VMIDMT_ACR_INM(b, m) \
	in_dword_masked(VMIDMT_ACR_ADDR(b), (m))
#define VMIDMT_ACR_OUT(b, v) \
	mmio_write_32(VMIDMT_ACR_ADDR(b), (v))
...
#define VMIDMT_NSACR_INM(b, m) \
	in_dword_masked(VMIDMT_NSACR_ADDR(b), (m))
#define VMIDMT_NSACR_OUT(b, v) \
	mmio_write_32(VMIDMT_NSACR_ADDR(b), (v))
...
#define VMIDMT_IDR0_IN(b) \
	in_dword_masked(VMIDMT_IDR0_ADDR(b), VMIDMT_IDR0_RMSK)
#define VMIDMT_IDR0_INM(b, m) \
	in_dword_masked(VMIDMT_IDR0_ADDR(b), (m))
...
#define VMIDMT_IDR1_IN(b) \
	in_dword_masked(VMIDMT_IDR1_ADDR(b), VMIDMT_IDR1_RMSK)
#define VMIDMT_IDR1_INM(b, m) \
	in_dword_masked(VMIDMT_IDR1_ADDR(b), (m))
...
#define VMIDMT_IDR2_IN(b) \
	in_dword_masked(VMIDMT_IDR2_ADDR(b), VMIDMT_IDR2_RMSK)
#define VMIDMT_IDR2_INM(b, m) \
	in_dword_masked(VMIDMT_IDR2_ADDR(b), (m))
...
#define VMIDMT_IDR4_IN(b) \
	in_dword_masked(VMIDMT_IDR4_ADDR(b), VMIDMT_IDR4_RMSK)
#define VMIDMT_IDR4_INM(b, m) \
	in_dword_masked(VMIDMT_IDR4_ADDR(b), (m))
...
#define VMIDMT_IDR5_IN(b) \
	in_dword_masked(VMIDMT_IDR5_ADDR(b), VMIDMT_IDR5_RMSK)
#define VMIDMT_IDR5_INM(b, m) \
	in_dword_masked(VMIDMT_IDR5_ADDR(b), (m))
...
#define VMIDMT_IDR7_IN(b) \
	in_dword_masked(VMIDMT_IDR7_ADDR(b), VMIDMT_IDR7_RMSK)
#define VMIDMT_IDR7_INM(b, m) \
	in_dword_masked(VMIDMT_IDR7_ADDR(b), (m))
...
#define VMIDMT_SGFAR0_INM(b, m) \
	in_dword_masked(VMIDMT_SGFAR0_ADDR(b), (m))
#define VMIDMT_SGFAR0_OUT(b, v) \
	mmio_write_32(VMIDMT_SGFAR0_ADDR(b), (v))
#define VMIDMT_SGFAR0_OUTM(b, m, v) \
	out_dword_masked_ns(VMIDMT_SGFAR0_ADDR(b), (m), (v), VMIDMT_SGFAR0_IN(b))
...
#define VMIDMT_SGFAR1_INM(b, m) \
	in_dword_masked(VMIDMT_SGFAR1_ADDR(b), (m))
#define VMIDMT_SGFAR1_OUT(b, v) \
	mmio_write_32(VMIDMT_SGFAR1_ADDR(b), (v))
#define VMIDMT_SGFAR1_OUTM(b, m, v) \
	out_dword_masked_ns(VMIDMT_SGFAR1_ADDR(b), (m), (v), VMIDMT_SGFAR1_IN(b))
...
#define VMIDMT_GFAR0_INM(b, m) \
	in_dword_masked(VMIDMT_GFAR0_ADDR(b), (m))
#define VMIDMT_GFAR0_OUT(b, v) \
	mmio_write_32(VMIDMT_GFAR0_ADDR(b), (v))
...
#define VMIDMT_GFAR1_INM(b, m) \
	in_dword_masked(VMIDMT_GFAR1_ADDR(b), (m))
#define VMIDMT_GFAR1_OUT(b, v) \
	mmio_write_32(VMIDMT_GFAR1_ADDR(b), (v))
...
#define VMIDMT_NSGFAR0_INM(b, m) \
	in_dword_masked(VMIDMT_NSGFAR0_ADDR(b), (m))
#define VMIDMT_NSGFAR0_OUT(b, v) \
	mmio_write_32(VMIDMT_NSGFAR0_ADDR(b), (v))
#define VMIDMT_NSGFAR0_OUTM(b, m, v) \
	out_dword_masked_ns(VMIDMT_NSGFAR0_ADDR(b), (m), (v), VMIDMT_NSGFAR0_IN(b))
...
#define VMIDMT_NSGFAR1_INM(b, m) \
	in_dword_masked(VMIDMT_NSGFAR1_ADDR(b), (m))
#define VMIDMT_NSGFAR1_OUT(b, v) \
	mmio_write_32(VMIDMT_NSGFAR1_ADDR(b), (v))
#define VMIDMT_NSGFAR1_OUTM(b, m, v) \
	out_dword_masked_ns(VMIDMT_NSGFAR1_ADDR(b), (m), (v), VMIDMT_NSGFAR1_IN(b))
...
#define VMIDMT_SGFSR_INM(b, m) \
	in_dword_masked(VMIDMT_SGFSR_ADDR(b), (m))
#define VMIDMT_SGFSR_OUT(b, v) \
	mmio_write_32(VMIDMT_SGFSR_ADDR(b), (v))
...
#define VMIDMT_GFSR_IN(b) \
	in_dword_masked(VMIDMT_GFSR_ADDR(b), VMIDMT_GFSR_RMSK)
#define VMIDMT_GFSR_INM(b, m) \
	in_dword_masked(VMIDMT_GFSR_ADDR(b), (m))
#define VMIDMT_GFSR_OUT(b, v) \
	mmio_write_32(VMIDMT_GFSR_ADDR(b), (v))
...
#define VMIDMT_NSGFSR_INM(b, m) \
	in_dword_masked(VMIDMT_NSGFSR_ADDR(b), (m))
#define VMIDMT_NSGFSR_OUT(b, v) \
	mmio_write_32(VMIDMT_NSGFSR_ADDR(b), (v))
#define VMIDMT_NSGFSR_OUTM(b, m, v) \
	out_dword_masked_ns(VMIDMT_NSGFSR_ADDR(b), (m), (v), VMIDMT_NSGFSR_IN(b))
...
#define VMIDMT_SGFSRRESTORE_OUTM(b, m, v) \
	out_dword_masked_ns(                                              \
		VMIDMT_SGFSRRESTORE_ADDR(b), (m), (v),                    \
...
#define VMIDMT_NSGFSRRESTORE_IN(b)                                       \
	in_dword_masked(                                                 \
		VMIDMT_NSGFSRRESTORE_ADDR(b), VMIDMT_NSGFSRRESTORE_RMSK  \
	)
...
#define VMIDMT_NSGFSRRESTORE_OUTM(b, m, v) \
	out_dword_masked_ns(                                             \
		VMIDMT_NSGFSRRESTORE_ADDR(b), (m), (v),                  \
...
#define VMIDMT_GFSYNDR0_INM(b, m) \
	in_dword_masked(VMIDMT_GFSYNDR0_ADDR(b), (m))
...
#define VMIDMT_GFSYNDR1_INM(b, m) \
	in_dword_masked(VMIDMT_GFSYNDR1_ADDR(b), (m))
...
#define VMIDMT_GFSYNDR2_INM(b, m) \
	in_dword_masked(VMIDMT_GFSYNDR2_ADDR(b), (m))
...
#define VMIDMT_NSGFSYNDR2_IN(b) \
	in_dword_masked(                                               \
		VMIDMT_NSGFSYNDR2_ADDR(b), VMIDMT_NSGFSYNDR2_RMSK      \
	)
...
#define VMIDMT_SSDRn_INI(b, n) \
	mmio_read_32(VMIDMT_SSDRn_ADDR(b, (n)))
...
#define VMIDMT_SSDRn_OUTMI(b, n, mask, val) \
	out_dword_masked_ns(                                 \
		VMIDMT_SSDRn_ADDR(b, (n)), (mask), (val),    \
...
#define VMIDMT_VMIDMTCR0_OUT(b, v) \
	mmio_write_32(VMIDMT_VMIDMTCR0_ADDR(b), (v))
#define VMIDMT_VMIDMTCR0_OUTM(b, m, v) \
	out_dword_masked_ns(                                  \
		VMIDMT_VMIDMTCR0_ADDR(b), (m), (v),           \
...
#define VMIDMT_VMIDMTACR_OUT(b, v) \
	mmio_write_32(VMIDMT_VMIDMTACR_ADDR(b), (v))
#define VMIDMT_VMIDMTACR_OUTM(b, m, v)                         \
	out_dword_masked_ns(                                   \
		VMIDMT_VMIDMTACR_ADDR(b), (m), (v),            \
...
#define VMIDMT_MSD0_IN(b) \
	in_dword_masked(VMIDMT_MSD0_ADDR(b), VMIDMT_MSD0_RMSK)
#define VMIDMT_MSD0_INM(b, m) \
	in_dword_masked(VMIDMT_MSD0_ADDR(b), (m))
#define VMIDMT_MSD0_OUT(b, v) \
	mmio_write_32(VMIDMT_MSD0_ADDR(b), (v))
...
#define VMIDMT_MSD1_IN(b) \
	in_dword_masked(VMIDMT_MSD1_ADDR(b), VMIDMT_MSD1_RMSK)
#define VMIDMT_MSD1_INM(b, m) \
	in_dword_masked(VMIDMT_MSD1_ADDR(b), (m))
#define VMIDMT_MSD1_OUT(b, v) \
	mmio_write_32(VMIDMT_MSD1_ADDR(b), (v))
...
#define VMIDMT_MSD2_IN(b) \
	in_dword_masked(VMIDMT_MSD2_ADDR(b), VMIDMT_MSD2_RMSK)
#define VMIDMT_MSD2_INM(b, m) \
	in_dword_masked(VMIDMT_MSD2_ADDR(b), (m))
#define VMIDMT_MSD2_OUT(b, v) \
	mmio_write_32(VMIDMT_MSD2_ADDR(b), (v))
...
#define VMIDMT_MSD3_IN(b) \
	in_dword_masked(VMIDMT_MSD3_ADDR(b), VMIDMT_MSD3_RMSK)
#define VMIDMT_MSD3_INM(b, m) \
	in_dword_masked(VMIDMT_MSD3_ADDR(b), (m))
#define VMIDMT_MSD3_OUT(b, v) \
	mmio_write_32(VMIDMT_MSD3_ADDR(b), (v))
...
#define VMIDMT_MCR_IN(b) \
	in_dword_masked(VMIDMT_MCR_ADDR(b), VMIDMT_MCR_RMSK)
#define VMIDMT_MCR_INM(b, m) \
	in_dword_masked(VMIDMT_MCR_ADDR(b), (m))
#define VMIDMT_MCR_OUT(b, v) \
	mmio_write_32(VMIDMT_MCR_ADDR(b), (v))
...
#define VMIDMT_SMRn_INI(b, n) \
	mmio_read_32(VMIDMT_SMRn_ADDR(b, (n)))
...
#define VMIDMT_S2VRn_INI(b, n) \
	mmio_read_32(VMIDMT_S2VRn_ADDR(b, (n)))
...
#define VMIDMT_S2VRn_OUTMI(b, n, mask, val) \
	out_dword_masked_ns(                                    \
		VMIDMT_S2VRn_ADDR(b, (n)), (mask), (val),       \
...
#define VMIDMT_AS2VRn_INI(b, n) \
	mmio_read_32(VMIDMT_AS2VRn_ADDR(b, (n)))
...
#define VMIDMT_AS2VRn_OUTMI(b, n, mask, val)                     \
	out_dword_masked_ns(                                     \
		VMIDMT_AS2VRn_ADDR(b, (n)), (mask), (val),       \
...
#define VMIDMT_IN(base, regsym)					\
	__vmidmthwio_in(base, regsym)

#define VMIDMT_INI(base, regsym, index)				\
	__vmidmthwio_ini(base, regsym, index)

#define VMIDMT_INM(base, regsym, mask)				\
	__vmidmthwio_inm(base, regsym, mask)

#define VMIDMT_INMI(base, regsym, index, mask)			\
	__vmidmthwio_inmi(base, regsym, index, mask)

#define VMIDMT_OUT(base, regsym, val)				\
	__vmidmthwio_out(base, regsym, val)
...
#define VMIDMT_ADDR(base, regsym)				\
	__vmidmthwio_addr(base, regsym)

#define VMIDMT_ADDRI(base, regsym, index)			\
	__vmidmthwio_addri(base, regsym, index)

#define VMIDMT_RMSK(regsym)					\
	__vmidmthwio_rmsk(regsym)

#define VMIDMT_RSHFT(regsym)					\
	__vmidmthwio_rshft(regsym)

#define VMIDMT_SHFT(regsym, fldsym)				\
	__vmidmthwio_shft(regsym, fldsym)

#define VMIDMT_FMSK(regsym, fldsym)				\
	__vmidmthwio_fmsk(regsym, fldsym)

#define VMIDMT_INFI(base, regsym, index, field)			\
	(VMIDMT_INMI(base, regsym, index,			\
		     VMIDMT_FMSK(regsym, field)) >>		\
...
#define VMIDMT_OUTFI(base, regsym, index, field, val)			\
	VMIDMT_OUTMI(base, regsym, index,				\
		     VMIDMT_FMSK(regsym, field),			\
		     (val) << VMIDMT_SHFT(regsym, field))

#define VMIDMT_INFC(regval, regsym, field)			\
	(((regval) & VMIDMT_FMSK(regsym, field)) >>		\
	 VMIDMT_SHFT(regsym, field))

#define __vmidmthwio_in(base, regsym)				\
	VMIDMT_##regsym##_IN(base)

#define __vmidmthwio_ini(base, regsym, index)			\
	VMIDMT_##regsym##_INI(base, index)

#define __vmidmthwio_inm(base, regsym, mask)			\
	VMIDMT_##regsym##_INM(base, mask)

#define __vmidmthwio_inmi(base, regsym, index, mask)		\
	VMIDMT_##regsym##_INMI(base, index, mask)

#define __vmidmthwio_out(base, regsym, val)			\
	VMIDMT_##regsym##_OUT(base, val)
...
#define __vmidmthwio_addr(base, regsym)				\
	VMIDMT_##regsym##_ADDR(base)

#define __vmidmthwio_addri(base, regsym, index)			\
	VMIDMT_##regsym##_ADDR(base, index)

#define __vmidmthwio_rmsk(regsym)				\
	VMIDMT_##regsym##_RMSK

#define __vmidmthwio_fmsk(regsym, fldsym)			\
	VMIDMT_##regsym##_##fldsym##_BMSK

#define __vmidmthwio_rshft(regsym)				\
	VMIDMT_##regsym##_SHFT

#define __vmidmthwio_shft(regsym, fldsym)			\
	VMIDMT_##regsym##_##fldsym##_SHFT


#endif /* _VMIDMT_HAL_HWIO_H_ */
